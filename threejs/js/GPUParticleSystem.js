...
THREE.GPUParticleSystem = function (options) {
    ...
    this.GPUParticleShader = null;
    function preLoad() {
        var vertex;
        var fragment;
        GPUParticleShader = SHADER_LOADER.load(function (data) {
        ...
        console.log(GPUParticleShader);
        // console.log(vs);
        // return {vertexShader : vs , fragmentShader : fs};
    }
    function ShaderLoad(vs, fs) {
        console.log('start');
        GPUParticleShader = {
            vertexShader: vs,
            fragmentShader: fs
    ...
    var GPUParticleShader = {
        vertexShader: [
            ...
            '	v.x = ( velocity.x - 0.0 ) * 3.0;',
            '	v.y = ( velocity.y - 0.0 ) * 3.0;',
            '	v.z = ( velocity.z - 0.0 ) * 3.0;',
    ...
    this.spawnParticle = function (options, vector, col) {
        ...
        currentContainer.spawnParticle(options, vector, col);
    };
